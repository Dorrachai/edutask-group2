...
def test_database_connection(daoSetUp):
    try:
        daoSetUp.connect()
        assert True
...
def test_create_duplicate_product_name(daoSetUp):
    data1 = {"product_name": "ProductD", "price": 45.0, "categories": ["Electronics", "Gadgets"], "is_active": True}
    data2 = {"product_name": "ProductD", "price": 55.0, "categories": ["Electronics", "Gadgets"], "is_active": False}
    daoSetUp.create(data1)
    with pytest.raises(pymongo.errors.DuplicateKeyError):
        daoSetUp.create(data2)
